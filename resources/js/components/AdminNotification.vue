<template>
    ...
    <li class="nav-item dropdown no-arrow mx-1">
        ...
        <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="alertsDropdown" v-if="unreadCount > 0">
            ...
            <a class="dropdown-item d-flex align-items-center" :href="`/admin/post_comments/${item.data.id}/edit`" @click="readNotifications(item)" v-for="item in unread" :key="item.id">
                <div class="mr-3">

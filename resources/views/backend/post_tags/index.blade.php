        ...
        <div class="table-responsive">
                <table class="table table-hover">
                    ...
                    <tr>
                        ...
                        <td>{{ $tag->created_at->format('Y m d h:i a') }}</td>
                        <td>
                            <div class="btn-group">
                                <a href="{{ route('admin.post_tags.edit', $tag->id) }}" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i></a>
                                <a href="javascript:void(0)" class="btn btn-sm btn-danger" onclick="if(confirm('Are you sure to delete this tag?')) { document.getElementById('tag-delete-{{ $tag->id }}').submit(); } else { return false; }"><i class="fa fa-trash"></i></a>

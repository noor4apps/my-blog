    ...
    <div class="card shadow mb-4">
        ...
        <div class="table-responsive">
                <table class="table table-hover">
                    ...
                    <tr>
                        <td><img src="{{ get_gravatar($comment->email, 40) }}" class="img-thumbnail"></td>
                        <td>
                            <a href="{{ $comment->url != null ? $comment->url : 'javascript:void(0);' }}" target="_blank">{{ $comment->name }}</a>
                            {{ $comment->user_id != null ? '(Member)' : '' }}
                        </td>
                        <td>
                            {{ $comment->comment }}
